...
MAP_CLASIFICACION_EMPRESA = {
    ...
    "GRANDES EMPRESAS": "Grande Empresa",
    "MYPE MICRO Y PEQUENAS EMPRESAS": "MYPE agrupado",
    "PYME PEQUENAS Y MEDIANAS EMPRESAS": "PYME histórico",
}


VALORES_MYPE_SI = {"Microempresa", "Pequeña empresa", "MYPE agrupado"}
VALORES_MYPE_NO = {"Mediana empresa", "Grande Empresa"}
